...
<head>
    ...
    <title>Honor's Page - BHRS College</title>
    ...
    <div class="body">
        ...
        <div class="min">
            ...
            <div class="main">
             <div class="row">
                <div class="col-md-12">
                  <div class="img" style="background-image: url('../img/accademic/hon-bg.jpg'); background-size: cover; background-position: center; height: 640px; width: auto">
                   <marquee><h1>WLLCOME TO </h1> <h2> BHRS UNVIRESTY</h2></marquee>
                     <div class="title-area gradient-bg-1">
                        <p> <span class="special-break"></span><span class="typer" id="main" data-words="Honours Programme" data-colors="white" data-delay="100" data-deleteDelay="1000"></span><span class="cursor" data-owner="main"></span></p>
      ...
      <section>
        ...
        <div class="container SidePadding">
            <div class="row">
             <div class="col-md-4">
                    <img class="img" style="height: 300px; width: 100%;object-fit: cover;" src="../img/accademic/1st.jpg">
                </div>
                <div class="col-md-8">
                    <img class="img" style="height: 300px; width: 100%;object-fit: cover;" src="../img/accademic/2nd.jpg">
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                                ...
                                <div align="justify">
                                    <md-content style="padding: 20px !important" class="shadow-lg p-3 mb-5 bg-white rounded _md">
                                        ...
                                        <!-- ngIf: categoryId ===1 --><div ng-if="categoryId ===1" class="ng-scope">
                                            <h1><p class="buetThemeColor">Honours Programme </p><hr></h1>
                                            <p>The Preliminary to Master's and Master's Final academic programs of BHRS Collage. Prepare the students for the demands and opportunities of the new century and empower them to become innovators and leaders. It challenges them academically to maximize their potential  and helps them to become top professionals in their respective fields. </p>
                                            <br>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="card1">
                                                        <div class="container">
                                                            <h5 style="color: #bf1430">15</h5>
                                                            <p style="font-size: 14px"><b>Honours .Dept</b></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="card1">
                                                        <div class="container">
                                                            <h5 style="color: #bf1430">1400</h5>
                                                            <p style="font-size: 14px"><b>Honours Programme<br>students</b></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="card1">
                                                        <div class="container">
                                                            <h5 style="color: #bf1430">70</h5>
                                                            <p style="font-size: 14px"><b> Honours Student's  <br>of research study </b></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
