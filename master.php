                            ...
                            <div align="justify">
                                <md-content style="padding: 20px !important" class="shadow-lg p-3 mb-5 bg-white rounded _md">
                                    ...
                                    <!-- ngIf: categoryId ===1 --><div ng-if="categoryId ===1" class="ng-scope">
                                        ...
                                        <p>The Preliminary to Master's and Master's Final academic programs of Brahmanbaria Govt collage.Prepare the students for the demands and opportunities of the new century and empower them to become innovators and leaders. It challenges them academically to maximize their potential  and helps them to become top professionals in their respective fields. </p>
                                        <br>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="card1">
